...
(function () {
  ...
  // Traducao pelo dicionario compartilhado (i18n.js). Antes havia aqui um
  // bloco de portugues escrito a mao, que so servia a um idioma e ficava
  // fora do processo de traducao do resto do site.
  var traduz = window.t || function (s) { return s; };
  CREDENTIALS.forEach(function (c) {
    c.name = traduz(c.name);
    c.body = traduz(c.body);
  });
